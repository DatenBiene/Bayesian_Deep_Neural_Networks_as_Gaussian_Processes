...
flags.DEFINE_string('nonlinearity', 'relu',
                    'Activation function')
flags.DEFINE_integer('depth', 100, 'Depth')
flags.DEFINE_float('weight_var', 1.79, 'weight var')
flags.DEFINE_float('bias_var', 0.83, 'weight var')
...
flags.DEFINE_boolean('return_reults', False, 'If save accuracy')
...
def main(argv):
  del argv  # Unused
  hparams = set_default_hparams(FLAGS.nonlinearity,
                                        FLAGS.depth,
                                        FLAGS.weight_var,
                                        FLAGS.bias_var)
