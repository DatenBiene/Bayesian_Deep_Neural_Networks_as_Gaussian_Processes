...
def load_fashion_mnist(num_train=50000):
    ...
    trainset = datasets.FashionMNIST('FashionMNIST_TRAINSET',
                                    download=True,
                                    train=True,
                                    transform=transform)
    valset = datasets.FashionMNIST('FashionMNIST_TESTSET',
                                download=True,
                                train=False,
                                transform=transform)
    nb_classes = 10
    ...
    num_train = np.min([num_train, 50000])
    ...
    return (trainset.data[:num_train].reshape(num_train,-1),
            train_one_hot_targets,
            valset.data.reshape(10000,-1),
            valid_one_hot_targets,
            trainset.data[-10000:].reshape(10000,-1),
            test_one_hot_targets)
